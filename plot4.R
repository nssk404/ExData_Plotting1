...
#Graph 1 - plot Global Active Power against time
plot(convertedDate, dataToProcess$Global_active_power, type="l", xlab="", ylab="Global Active Power")

#Graph 2 - plot Voltage against time
plot(convertedDate, dataToProcess$Voltage, type="l", xlab="datetime", ylab="Voltage")

#Graph 3 - plot Energy sub metering against time
...
#Graph 4 - plot Global Reactive Power against time
plot(convertedDate, dataToProcess$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
